...
public class Drivetrain implements Subsystem {
    ...
    private SystemState currentState = SystemState.MANUAL;
    private WantedState wantedState = WantedState.MANUAL;

    Telemetry telemetry = new Telemetry(Constants.Drivetrain.maxVelocity);
   ...
   // END DRIVETRAIN
    ...
    public void writePeriodicOutputs(double timestamp) {
        ctreframe.registerTelemetry(telemetry::telemeterize);
        switch(currentState) {
            case IDLE:
